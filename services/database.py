...
class UserEntity(DatabaseEntity):
    """Entity class for user-related database operations"""
    
    @staticmethod
    def create_user(user_id: str) -> User:
        """Create a new user"""
        conn = UserEntity.get_db_connection()
        cursor = conn.cursor()
    ...
    @staticmethod
    def get_user_id_by_external_id(external_user_id: str) -> int:
...
class CalendarEntity(DatabaseEntity):
    """Entity class for calendar-related database operations"""
    
    @staticmethod
    def create_calendar(user_id: int, url: str) -> Calendar:
        """Create a new calendar for a user"""
        conn = CalendarEntity.get_db_connection()
        cursor = conn.cursor()
    ...
    def get_calendars(user_id: str = None) -> List[Calendar]:
        ...
        if user_id:
            ...
            user_internal_id = UserEntity.get_user_id_by_external_id(user_id)
    ...
    @staticmethod
    def get_existing_event_uids(calendar_id: int) -> set:
...
# Event entity class
class EventEntity(DatabaseEntity):
    """Entity class for event-related database operations"""
    ...
    def create_event(calendar_id: int, uid: str, title: str, description: str, 
        ...
        """Create a new event"""
        conn = EventEntity.get_db_connection()
        cursor = conn.cursor()
    ...
    @staticmethod
    def upsert_event(calendar_id: int, uid: str, title: str, description: str,
    ...
    @staticmethod
    def delete_events_by_uids(calendar_id: int, deleted_uids: set):
