...
def create_calendar_blueprint(auth_service, calendar_service):
    ...
    def create_calendar_api(args):
        ...
        try:
            ...
            user = calendar_service.create_user(user_id)
            
            # Create calendar
            calendar = calendar_service.create_calendar(user.id, url)
    ...
    def delete_calendar_api(calendar_id):
        ...
        try:
            ...
            # Delete calendar
            deleted = calendar_service.delete_calendar(calendar_id, user_id)
